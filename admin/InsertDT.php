...
//Them sanpham
$sql="Insert into sanpham(MASP,TENSP,MALOAISP,MANSX,TRANGTHAI,GIA,HINHDAIDIEN,HINH1,HINH2,HINH3,HINH4,TINHTRANGXOA) values ('".$Ma."','".$TenDT."',1,".$HSX.",3,".$Gia.",'".$HINHDAIDIEN."','".$Hinh1."','".$Hinh2."','".$Hinh3."','".$Hinh4."',0)";
$conn->query($sql);
//Them ChiTietSanPham
$sql="Insert into thongsokythuatdienthoai(MANHINH,CPU,RAMROM,CAMERA,PIN,MOTADAI,THONGSOKYTHUAT,CHITIETTHONGSO,MASP) values ('".$ManHinh."','".$CPU."','".$RAMROM."','".$CAMERA."','".$PIN."','".$Motadai."','".$THONGSO."','".$ChiTietThongSo."','".$Ma."')";
$conn->query($sql);
////////////////////////////////////////////////////////////////////////
