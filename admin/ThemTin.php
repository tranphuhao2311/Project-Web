				...
				<div class="box span12">
					...
					<div class="box-content">
						...
						<?php
							...
							{
								$squery='insert into tintuc (TDe,TomTat,NDung,NguoiDang,NgayDang,Hinh) '
								. 'VALUE (\''.$_POST['tieude'].'\',\''.$_POST['tomtat'].'\',\''.$_POST['noidung'].'\',"'.'","'.$_POST['hinh'].'")';
