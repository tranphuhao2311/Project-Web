			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span><strong>ĐIỆN THOẠI</strong></h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" name="frm" action="SuaDT.php" method="post" enctype="multipart/form-data">
						  <fieldset>
						   <?php
									$masp=$_GET["msp"];
									require("connect.php");
									$sql="Select * From sanpham sp, thongsokythuatdienthoai ts where sp.MASP=ts.MASP and sp.MASP='".$masp."'";
						 ...
						 <div class="control-group">
							  <label class="control-label" for="typeahead"><strong>Tên điện thoại: </strong></label>
							  <div class="controls">
								<input name="TenDT" type="text" class="span6 typeahead" id="TenDT" style="width: 220px;" value="<?php echo $row["TENSP"];?>" />
							  </div>
							</div>
						  ...
						  <div class="control-group">
							...
							<!--CPU-->
							 <div class="control-group">
							  ...
							  <div class="controls">
								<input name="CPU" type="text" class="span6 typeahead" id="CPU" style="width: 220px;" value="<?php echo $row["CPU"];?>"/>
							  </div>
							</div>
							<!--RAM/ROM-->
							 <div class="control-group">
							  ...
							  <div class="controls">
								<input name="RAMROM" type="text" class="span6 typeahead" id="RAMROM" style="width: 220px;" value="<?php echo $row["RAMROM"];?>"/>
							  </div>
							</div>
							<!--CAMERA-->
							 <div class="control-group">
							  ...
							  <div class="controls">
								<input name="CAMERA" type="text" class="span6 typeahead" id="CAMERA" style="width: 220px;" value="<?php echo $row["CAMERA"];?>"/>
							  </div>
							</div>
							<!--PIN-->
							 <div class="control-group">
							  ...
							  <div class="controls">
								<input name="PIN" type="text" class="span6 typeahead" id="PIN" style="width: 220px;" value="<?php echo $row["PIN"];?>"/>
							  </div>
							</div>
							<!--Hinh sp-->
							<div class="control-group">
