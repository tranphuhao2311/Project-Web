...
//Them sanpham
$sql="update sanpham set TENSP='".$TenPhuKien."',TRANGTHAI=".$TT.",GIA=".$Gia." where MASP='".$Ma."'";
$conn->query($sql);
//Them ChiTietSanPham
$sql="update thongsophukien set LOAIPK='".$LoaiPK."',MOTANGAN='".$Motangan."',MOTADAI='".$Motadai."',THONGSOKYTHUAT='".$THONGSO."' where MASP='".$Ma."'";
$conn->query($sql);
////////////////////////////////////////////////////////////////////////
