			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" name="frm" action="SuaTablet.php" method="post" enctype="multipart/form-data">
						  <fieldset>
						   <?php
									$masp=$_GET["msp"];
									require("connect.php");
									$sql="Select * From sanpham sp, thongsokythuatmaytinhbang ts where sp.MASP=ts.MASP and sp.MASP='".$masp."'";
