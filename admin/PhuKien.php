			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" name="frm" action="InsertPhuKien.php" method="post" enctype="multipart/form-data">
						  <fieldset>
						  <!--Tên điện thoại-->
						 <div class="control-group">
							  <label class="control-label" for="typeahead"><strong>Tên: </strong></label>
							  <div class="controls">
								<input name="TenPhuKien" type="text" class="span6 typeahead" id="TenPhuKien" style="width: 220px;" />
							  </div>
							</div>
							<div class="control-group">
                        ...
                        <tbody><tr>
                            <td style="width: 180px;">Tên thông số</td>
                            <td>Nội dung</td>
                        </tr>
