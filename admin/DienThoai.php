			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" name="frm" action="InsertDT.php" method="post" enctype="multipart/form-data">
						  <fieldset>
						  <!--Tên điện thoại-->
						 <div class="control-group">
							  <label class="control-label" for="typeahead"><strong>Tên điện thoại: </strong></label>
							  <div class="controls">
								<input name="TenDT" type="text" class="span6 typeahead" id="TenDT" style="width: 220px;" />
							  </div>
							</div>
							...
							<!--Thông số kỹ thuật-->
							 <div class="control-group" style="width: 83.5%;float: right;">
								...
								<table cellpadding="0" cellspacing="0">
										...
										<tr>
											<td style="width: 180px;">Camera chính:</td>
											<td></td>
										</tr>
										...
										<tr>
											<td style="width: 180px;">Kích cỡ:</td>
											<td></td>
										</tr>
							...
							<!--Thông số kỹ thuật chi tiết-->
							 <div class="control-group" style="width: 83.5%;float: right;">
								<textarea id="ChiTietThongSo" name="ChiTietThongSo" cols="80" rows="10">
									...
									<tr class="row_item">                                    
										<td class="left_row_item">Camera chính</td>
										<td class="right_row_item"></td>
									</tr>
									<tr class="row_item">                                    
										<td class="left_row_item">Camera phụ</td>
										<td class="right_row_item"></td>
									</tr>
									...
									<tr class="row_item">                                    
										...
										<td class="right_row_item"></td>
											...
											<tr>
												<td colspan="2">
													<div style="background-color: #f2f2f2; margin: -1px -20px; height: 40px; padding-left: 20px; line-height: 40px;"><b style="color: #ff6600;">Giải trí &amp; Ứng dụng</b></div>
												</td>
											</tr>
