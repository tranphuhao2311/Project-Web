...
//Them sanpham
$sql="update sanpham set TENSP='".$TenDT."',MANSX=".$HSX.",TRANGTHAI=".$TT.",GIA=".$Gia." where MASP='".$Ma."'";
$conn->query($sql);

//Them ChiTietSanPham
$sql="update thongsokythuatdienthoai set MANHINH='".$ManHinh."',CPU='".$CPU."',RAMROM='".$RAMROM."',CAMERA='".$CAMERA."',PIN='".$PIN."',MOTADAI='".$Motadai."',THONGSOKYTHUAT='".$THONGSO."',CHITIETTHONGSO='".$ChiTietThongSo."' where MASP='".$Ma."'";
$conn->query($sql);
...
{	
	...
	header('Location: DienThoaiUpdate.php?msp='.$Ma.'&hsx='.$HSX);
