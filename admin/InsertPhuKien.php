...
//Them sanpham
$sql="Insert into sanpham(MASP,TENSP,MALOAISP,MANSX,TRANGTHAI,GIA,HINHDAIDIEN,HINH1,HINH2,HINH3,HINH4,TINHTRANGXOA) values ('".$Ma."','".$TenPhuKien."',4,0,3,".$Gia.",'".$HINHDAIDIEN."','".$Hinh1."','".$Hinh2."','".$Hinh3."','".$Hinh4."',0)";
$conn->query($sql);
//Them ChiTietSanPham
$sql="Insert into thongsophukien(LOAIPK,MOTANGAN,MOTADAI,THONGSOKYTHUAT,MASP) values (".$LoaiPK.",'".$Motangan."','".$Motadai."','".$THONGSO."','".$Ma."')";
$conn->query($sql);
////////////////////////////////////////////////////////////////////////
