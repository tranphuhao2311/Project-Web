...
//Them ChiTietSanPham
$sql="update thongsokythuatmaytinhbang set MANHINH='".$ManHinh."',CPU='".$CPU."',RAMROM='".$RAMROM."',CAMERA='".$CAMERA."',PIN='".$PIN."',MOTADAI='".$Motadai."',THONGSOKYTHUAT='".$THONGSO."',CHITIETTHONGSO='".$ChiTietThongSo."' where MASP='".$Ma."'";
$conn->query($sql);
...
{	
	...
	header('Location: TabletUpdate.php?msp='.$Ma.'&hsx='.$HSX);
