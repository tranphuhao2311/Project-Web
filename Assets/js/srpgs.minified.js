...
$(document).ready(function(){for(var s=1,t="1.0.1",r=0;r<srpgs_photos.length;r++)srpgs_photos[r].image.length&&$("#srpgs-thumbs-gallery").html($("#srpgs-thumbs-gallery").html() +'<div class="border-thumbs-gallery">' + '<img src="'+srpgs_path_thumb+srpgs_photos[r].image+'" id="srpgs-thumb-'+r+'" title="'+(srpgs_photos[r].title&&srpgs_photos[r].title.length?srpgs_photos[r].title:"")+'" />' +'</div>')
...
var p=1,o=0,n=!1,a=function(t){if(!n){parseInt(t)>=0?o=parseInt(t)+1:"next"==t?(o++,o==srpgs_photos.length+1&&(o=1)):(o--,0==o&&(o=srpgs_photos.length)),$("img",$("#srpgs-thumbs-gallery")).parent().removeClass("active"),$("img#srpgs-thumb-"+(o-1),$("#srpgs-thumbs-gallery")).parent().addClass("active"),1==o?(i(0),s=1):o*($("img",$("#srpgs-thumbs-gallery")).height()+4)>$("#srpgs-thumbs-gallery").height()*s&&i("down")
var r=p
p=1==p?2:1,h(srpgs_photos[o-1],r,p)}},c=-1,h=function(s,t,r){n=!0,c--,$("#srpgs-rotate-"+r).css({display:"block","z-index":c * (-1)}),$("img",$("#srpgs-rotate-"+r)).attr("src",srpgs_path_pics+s.image),$("#srpgs-rotate-"+t).fadeOut(function(){setTimeout(function(){$("#srpgs-picture").css({display:"block"}),n=!1},500)}),$("#srpgs-picture").css({display:"none"}),s.title&&s.title.length?($("#srpgs-picture-title").show(),$("#srpgs-picture-title").html(s.title)):$("#srpgs-picture-title").hide(),s.url&&s.url.length&&s.subject&&s.length?($("#srpgs-picture-url").attr("href",s.url).html(s.subject),$(".srpgs-picture-link").show()):$(".srpgs-picture-link").hide()},u=function(){$("#srpgs-control-play-pause").css({"background-image":"url(images/btn_play.png)"}),clearInterval(g)}
